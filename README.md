...
- **🧠 AI-Powered Intelligence**: Leverage Google Gemini AI for intelligent inventory insights and automated decision-making
- **📱 Cross-Platform Mobile**: Built with React Native for seamless iOS and Android experience
- **☁️ Cloud-First Architecture**: Firebase integration ensures real-time synchronization and scalability
...
- **Multi-language Support** - Communicate with AI assistant in multiple languages (English, Hindi)
...
- **Bottom Tab Navigation** - Easy access to all major features
